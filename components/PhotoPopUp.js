...
export default function PhotoPopUp({ src, onClick, open }) {
  return (
    <>
              ...
              >
                <Dialog.Panel className="overflow-hidden text-left align-middle transition-all transform pointer-events-none">
                  <div
                    ...
                    className="relative m-auto max-h-[90vh] max-w-[90vw] w-full"
                  >
                    <Image
                      style={{
                        aspectRatio: src.aspectRatio,
                      ...
                      src={src}
                      sizes="100vw"
                      imageClassName="object-cover w-screen h-full rounded-2xl"
                      className={`object-contain h-full  pointer-events-none border-4 border-white overflow-hidden rounded-2xl`}
                      alt=""
                    />
                    <button
